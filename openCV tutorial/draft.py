...
#
#     rectangle_pts = np.array([[100, 100], [300, 100], [300, 250], [100, 250]], np.int32).reshape((-1, 1, 2))
#     cv2.polylines(img, [rectangle_pts], isClosed=True, color=(255, 0, 0), thickness=2)
#
